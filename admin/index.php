...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                    ...
                                    <div class="toggle-wrap nk-block-tools-toggle"><a href="#" class="btn btn-icon btn-trigger toggle-expand me-n1" data-target="pageMenu"><em class="icon ni ni-more-v"></em></a>
                                        <div class="toggle-expand-content" data-content="pageMenu">
                                            <ul class="nk-block-tools g-3">
                                                <li>
                                                    <div class="drodown"><a href="#" class="dropdown-toggle btn btn-white btn-dim btn-outline-light" data-bs-toggle="dropdown"><em class="d-none d-sm-inline icon ni ni-calender-date"></em><span><span class="d-none d-md-inline">Last</span> 30 Days</span><em class="dd-indc icon ni ni-chevron-right"></em></a>
                                                        <div
                                        ...
                                        <div class="card">
                                            <div class="card-inner">
                                                <div class="card-title-group align-start mb-2">
                                                    ...
                                                    <div class="card-tools"><em class="card-hint icon ni ni-help-fill" data-bs-toggle="tooltip" data-bs-placement="left" title="Students Enrolement"></em></div>
                                                </div>
                                                <div class="align-end gy-3 gx-5 flex-wrap flex-md-nowrap flex-lg-wrap flex-xxl-nowrap">
                                                    <div class="nk-sale-data-group flex-md-nowrap g-4">
                                                        <div class="nk-sale-data"><span class="amount">5490 <span class="change down text-danger"><em class="icon ni ni-arrow-long-down"></em>16.93%</span></span><span class="sub-title">This Month</span></div>
                                                        <div class="nk-sale-data"><span class="amount">1480<span class="change up text-success"><em class="icon ni ni-arrow-long-up"></em>4.26%</span></span><span class="sub-title">This Week</span></div>
                                                    </div>
                                                    <div class="nk-sales-ck sales-revenue"><canvas class="student-enrole" id="enrolement"></canvas></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="card-inner pb-0">
                                                    ...
                                                    <div class="data">
                                                        <div class="data-group">
                                                            ...
                                                            <div class="info text-end"><span class="change up text-danger"><em class="icon ni ni-arrow-long-up"></em>4.63%</span><br><span>vs. last month</span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="nk-ecwg3-ck"><canvas class="courseSells" id="totalSells"></canvas></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="nk-ecwg nk-ecwg3">
                                                ...
                                                <div class="nk-ecwg3-ck"><canvas class="courseSells" id="weeklySells"></canvas></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card card-full">
                                    <div class="card-inner">
                                        ...
                                        <div class="d-flex">
                                            <div class="h-250px mt-n2 flex-grow-1"><canvas class="course-progress-chart" id="courseProgress"></canvas></div>
                                            <ul class="flex-shrink-0 gy-2">
                                                <li class="align-center"><span class="dot dot-lg sq me-1" data-bg="#f98c45"></span><span> Web Development</span></li>
                                                <li class="align-center"><span class="dot dot-lg sq me-1" data-bg="#9cabff"></span><span> Mobile Application</span></li>
                                                <li class="align-center"><span class="dot dot-lg sq me-1" data-bg="#8feac5"></span><span> Graphics Design</span></li>
                                                <li class="align-center"><span class="dot dot-lg sq me-1" data-bg="#6b79c8"></span><span> Database</span></li>
                                                <li class="align-center"><span class="dot dot-lg sq me-1" data-bg="#79f1dc"></span><span> Marketing</span></li>
                                                <li class="align-center"><span class="dot dot-lg sq me-1" data-bg="#FF65B6"></span><span> Machine Learning</span></li>
                                                <li class="align-center"><span class="dot dot-lg sq me-1" data-bg="#6A29FF"></span><span> Data Science</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card h-100">
                                    <div class="card-inner">
                                        <div class="card-title-group mb-2">
                                            ...
                                            <div class="card-tools">
                                                <div class="dropdown"><a href="#" class="dropdown-toggle link link-light link-sm dropdown-indicator" data-bs-toggle="dropdown">Weekly</a>
                                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-end">
                                                        <ul class="link-list-opt no-bdr">
                                        ...
                                        <ul class="nk-top-products">
                                            <li class="item">
                                                <div class="user-avatar sq bg-success-dim me-3"><span>UI/X</span></div>
                                                <div class="info">
                                            ...
                                            <li class="item">
                                                <div class="user-avatar sq bg-warning-dim me-3"><span>AD</span></div>
                                                <div class="info">
                                            ...
                                            <li class="item">
                                                <div class="user-avatar sq bg-danger-dim me-3"><span>WD</span></div>
                                                <div class="info">
                                            ...
                                            <li class="item">
                                                <div class="user-avatar sq bg-primary-dim me-3"><span>ML</span></div>
                                                <div class="info">
                                            ...
                                            <li class="item">
                                                <div class="user-avatar sq bg-info-dim me-3"><span>RD</span></div>
                                                <div class="info">
                                    ...
                                    <div class="card-inner-group">
                                        <div class="card-inner">
                                            <div class="card-title-group">
                                                ...
                                                <div class="card-tools"><a href="instructor-list.php" class="link">View All</a></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-inner card-inner-md">
                                            <div class="review-item d-flex justify-content-between">
                                                <div class="user-card">
                                                    <div class="user-avatar bg-info-dim"><span>AL</span></div>
                                                    <div class="user-info"><span class="lead-text">Ashley Lawson</span><span class="sub-text">ashley@softnio.com</span></div>
                                                </div>
                                                <div class="review-status">
                                                    <ul class="review-stars d-flex">
                                                        <li><em class="icon ni ni-star-fill text-warning"></em></li>
                                        ...
                                        <div class="card-inner card-inner-md">
                                            <div class="review-item d-flex justify-content-between">
                                                <div class="user-card">
                                                    <div class="user-avatar bg-warning-dim"><span>JM</span></div>
                                                    <div class="user-info"><span class="lead-text">Jane Montgomery</span><span class="sub-text">jane84@example.com</span></div>
                                                </div>
                                                <div class="review-status">
                                                    <ul class="review-stars d-flex">
                                                        <li><em class="icon ni ni-star-fill text-warning"></em></li>
                                        ...
                                        <div class="card-inner card-inner-md">
                                            <div class="review-item d-flex justify-content-between">
                                                <div class="user-card">
                                                    <div class="user-avatar bg-pink-dim"><span>LH</span></div>
                                                    <div class="user-info"><span class="lead-text">Larry Henry</span><span class="sub-text">larry108@example.com</span></div>
                                                </div>
                                                <div class="review-status">
                                                    <ul class="review-stars d-flex">
                                                        <li><em class="icon ni ni-star-fill text-warning"></em></li>
                                    ...
                                    <ul class="nk-support">
                                        <li class="nk-support-item">
                                            ...
                                            <div class="nk-support-content">
                                                ...
                                                <p>Thanks for contact us with your issues...</p><span class="time">6 min ago</span></div>
                                        </li>
                                        <li class="nk-support-item">
                                            ...
                                            <div class="nk-support-content ">
                                                ...
                                                <p>Thanks for contact us with your issues...</p><span class="time">2 Hours ago</span></div>
                                        </li>
                                        <li class="nk-support-item">
                                            ...
                                            <div class="nk-support-content">
                                                ...
                                                <p>Thanks for contact us with your issues...</p><span class="time">3 Hours ago</span></div>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="nk-ecwg nk-ecwg4 h-100">
                                        <div class="card-inner flex-grow-1">
                                            <div class="card-title-group mb-4">
                                                ...
                                                <div class="card-tools">
                                                    <div class="dropdown"><a href="#" class="dropdown-toggle link link-light link-sm dropdown-indicator" data-bs-toggle="dropdown">30 Days</a>
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-end">
                                                            <ul class="link-list-opt no-bdr">
                                            ...
                                            <div class="data-group">
                                                <div class="nk-ecwg4-ck"><canvas class="lms-doughnut-s1" id="trafficSources"></canvas></div>
                                        ...
                                        <div class="card-inner card-inner-md bg-light">
                                            <div class="card-note"><em class="icon ni ni-info-fill"></em><span>Traffic channels have beed generating the most traffics over past days.</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="<?= ROOT_URL ?>assets/Js/charts/chart-lms.js?ver=3.0.3"></script>
</body>
